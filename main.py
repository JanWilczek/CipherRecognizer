...
#for j in [200, 220, 240, 260]:       # Best result yet: 240
    #for k in [60, 80, 100, 120, 140]:     # Best result yet: 120 error_rate=12,(72)
...
for i in range (0,3):
    ...
    for i in range(0,configuration_manager.nb_configurations()):
        ...
        classifier = ANNClassifier((240,120),activation_function='logistic',solver='adam', alpha=0.0002, nb_iterations=350)
        # training
